...
export const ROUTES = {
  ...
  VIEWS: "/views",
  VIEW_DETAIL: "/views/:slug",
  VIEW_CREATE: "/views/create",
  PAGES: "/pages",
  PAGE_DETAIL: "/pages/:slug",
  PAGE_CREATE: "/pages/create",
  PAGE_PRESENT: "/pages/:slug/present",
  API_KEYS: "/api-keys",
...
export const routes = {
  ...
  views: () => ROUTES.VIEWS,
  viewDetail: (slug: string) => `/views/${slug}`,
  viewCreate: () => ROUTES.VIEW_CREATE,
  pages: () => ROUTES.PAGES,
  pageDetail: (slug: string) => `/pages/${slug}`,
  pageCreate: () => ROUTES.PAGE_CREATE,
  pagePresent: (slug: string) => `/pages/${slug}/present`,
...
export const routeConfig: Record<string, RouteConfig> = {
  ...
  views: {
    ...
    section: "platform",
    showInNav: true,
    lazy: () => import("@/pages/views"),
    permissions: ["views.read"],
  },
  viewCreate: {
    key: "viewCreate",
    path: ROUTES.VIEW_CREATE,
    label: "Create View",
    parent: "views",
    lazy: () => import("@/pages/views/create"),
    permissions: ["views.write"],
  },
  viewDetail: {
    key: "viewDetail",
    path: ROUTES.VIEW_DETAIL,
    label: "View",
    parent: "views",
    lazy: () => import("@/pages/views/[slug]"),
    permissions: ["views.read"],
  },
  pages: {
    key: "pages",
    ...
    section: "platform",
    showInNav: true,
    lazy: () => import("@/pages/pages"),
    permissions: ["pages.read"],
  },
  pageCreate: {
    key: "pageCreate",
    path: ROUTES.PAGE_CREATE,
    label: "Create Page",
    parent: "pages",
    lazy: () => import("@/pages/pages/create"),
  ...
  pageDetail: {
    ...
    label: "Page",
    parent: "pages",
    lazy: () => import("@/pages/pages/[slug]"),
    permissions: ["pages.read"],
  },
  pagePresent: {
    key: "pagePresent",
    path: ROUTES.PAGE_PRESENT,
    label: "Present",
    parent: "pageDetail",
    lazy: () => import("@/pages/pages/[slug]/present"),
    permissions: ["pages.read"],
  },
  apiKeys: {
    key: "apiKeys",
